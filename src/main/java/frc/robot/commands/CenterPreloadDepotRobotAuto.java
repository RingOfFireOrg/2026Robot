...
public class CenterPreloadDepotRobotAuto {
  public static Command create(Drive drive, Turret turret, Indexer indexer, Transfer transfer, Intake intake) {
    return Commands.parallel(// turret should lock on the whole auto
      Commands.sequence(
        ...
        new RobotDriveForTime(drive, 0.0, 1, 0.0, 2.1),//line up with depot
        ...
        Commands.parallel(
          intake.rollersOut(),
          new RobotDriveForTime(drive, -0.25, 0.0, 0.0, 3.75)).withTimeout(4.2),//go into depot
